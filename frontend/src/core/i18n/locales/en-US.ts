...
export const enUS: Translations = {
  ...
  welcome: {
    ...
    description:
      "Welcome to 🦌 QcdocAgent, an open source super agent. With built-in and custom skills, QcdocAgent helps you search on the web, analyze data, and generate artifacts like slides, web pages and do almost anything.",
  ...
  inputBox: {
    ...
    voiceInputStart:
      "Dictate with voice. QcdocAgent receives only transcribed text; audio is handled by your browser or system speech service.",
  ...
  agents: {
    ...
    saving: "Saving agent...",
    saveRequested:
      "Save requested. QcdocAgent is generating and saving an initial version now.",
    saveHint:
    ...
    agentCreatedPendingRefresh:
      "The agent was created, but QcdocAgent could not load it yet. Please refresh this page in a moment.",
    more: "More actions",
  ...
  // Workspace
  workspace: {
    officialWebsite: "QcdocAgent's official website",
  ...
  channels: {
    ...
    descriptions: {
      buzz: "Buzz channels and direct messages through your QcdocAgent agent.",
      telegram: "Telegram direct messages through your QcdocAgent bot.",
      slack: "Slack workspace messages and mentions.",
      discord: "Discord server messages through your QcdocAgent bot.",
      feishu: "Feishu and Lark messages through your QcdocAgent app.",
      dingtalk: "DingTalk Stream Push messages through your QcdocAgent bot.",
      wechat: "WeChat iLink messages through your QcdocAgent bot.",
      wecom: "WeCom messages through your QcdocAgent AI bot.",
    },
  ...
  toolCalls: {
    ...
    skillInstallTooltip: "Install skill and make it available to QcdocAgent",
  ...
  shortcuts: {
    ...
    keyboardShortcutsDescription:
      "Navigate QcdocAgent faster with keyboard shortcuts.",
  ...
  settings: {
    title: "Settings",
    description: "Adjust how QcdocAgent looks and behaves for you.",
    sections: {
      account: "Account",
    ...
    memory: {
      title: "Memory",
      description:
        "QcdocAgent automatically learns from your conversations in the background. These memories help QcdocAgent understand you better and deliver a more personalized experience.",
  ...
  "mcpServers": {
    ...
    channels: {
      title: "Channels",
      description:
        "Connect IM accounts that can send messages to QcdocAgent from outside the browser.",
      disabled:
    ...
    integrations: {
      ...
      lark: {
        ...
        authStarted:
          "Authorization page opened. QcdocAgent will detect completion automatically.",
        authorizationStillPending:
          'Authorization is not complete yet. Finish it in the browser; QcdocAgent keeps checking automatically. You can click "I completed authorization" if the page does not update.',
        permissionTitle: "Authorization scope",
        permissionDescription:
          "By default, QcdocAgent only completes the base sign-in and does not request any business permissions. Select the domains you need here; connected users can re-authorize to add more (scopes accumulate).",
        authDomains: {
          calendar: {
            label: "Calendar",
            description:
        ...
        openAuthLinkDescription:
          "Open the link below to authorize. QcdocAgent keeps checking automatically and will save the connection after approval.",
        waitingAuthTitle: "Waiting for Lark authorization",
        waitingAuthDescription:
          "Finish authorization in the browser page that just opened. QcdocAgent will update this panel automatically; the button below is only a fallback.",
        ...
        authNextDescription:
          "Click “Connect Lark”; QcdocAgent checks the current status first and opens browser authorization only when disconnected or expired.",
      },
    },
    skills: {
      title: "Agent Skills",
      ...
      emptyDescription:
        "Put your agent skill folders under the `/skills/custom` folder under the root folder of QcdocAgent.",
    ...
    notification: {
      title: "Notification",
      description:
        "QcdocAgent only sends a completion notification when the window is not active. This is especially useful for long-running tasks so you can switch to other work and get notified when done.",
      requestPermission: "Request notification permission",
      deniedHint:
        "Notification permission was denied. You can enable it in your browser's site settings to receive completion alerts.",
      testButton: "Send test notification",
      testTitle: "QcdocAgent",
    ...
    account: {
      ...
      ssoPasswordMessage:
        "This account signs in with {provider}, so QcdocAgent cannot manage or change its password here. Use your SSO provider's account settings instead.",
  ...
  login: {
    ...
    rememberMeDescription:
      "Keep this browser session when possible. QcdocAgent stores only your email, never your password.",
    ...
    adminSetupRequiredDescription:
      "QcdocAgent needs an administrator account before new regular accounts can be created.",
